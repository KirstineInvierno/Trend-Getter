...
def extract_trends(topics, timeframe, geo=""):
    pytrends = TrendReq(hl='en-GB', tz=60) #BST not GMT
    pytrends.build_payload(topics, cat=0, timeframe=timeframe, geo=geo, gprop='')
    ...
    logging.info("Saved trends data.")

if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument("topics", help="Comma-separated list of topics (max 5)")
    parser.add_argument("--timeframe", default="today 5-y", help="Timeframe for data (e.g., 'now 7-d', 'today 1-m')")
    parser.add_argument("--geo", default="", help="Geographical region code (e.g., 'GB' for UK)")
