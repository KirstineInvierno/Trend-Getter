...
class TestS3Loader:
    ...
    def test_format_date_format(self, dt, expected):
    ...
    def test_download_json_creates_expected_file_and_logs(self, mock_date, mock_uuid, tmp_path, caplog):
        test_data = [{"msg": "hello"}]
    ...
    def test_load_to_s3_uploads_file_and_logs(self, mock_session, mock_format_date, mock_random_string, caplog):
        test_data = [{"msg": "hello"}]
        expected_filename = "abcd--04-08-2025T15-45-26.json"
